...
const PremiumLease = () => (
  <Layout>
    <SEO title="Premium Lease" />
    <Container>
      <Title>Premium Lease</Title>
      <Content>
        <Text>
        ...
        <Text>
          ...
          selling a total of Fifteen Thousand (15000) copies of such Recordings
          or any combination of such Recordings, condition upon the payment to
          the Licensor a sum of Ninety-nine dollars ($99.00), receipt of which
          is confirmed. Additionally licensor shall be permitted to distribute
          Unlimited free internet downloads or streams for non-profit and
          non-commercial use. This license allows up to 300,000 (300,000) not
          monetized audio streams to sites (like Spotify, RDIO, Rhapsody). This
          lease is eligible for monetization on YouTube.
        </Text>
        ...
        <Text>
          ...
          music video streamed online (Youtube, Vimeo, etc..) for up to 500000
          non-monetized video streams on all total sites. A separate
        ...
        <Text>
          The Licensor hereby grants to Licensee broadcasting rights up to 2
          Radio Stations.
        </Text>
        ...
        <Text>
          ...
          shall pay to licensor the sum of $49.00 US dollars and other good and
