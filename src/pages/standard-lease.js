...
const StandardLease = () => (
  <Layout>
    <SEO title="Standard Lease" />
    <Container>
      <Title>Standard Lease</Title>
      <Content>
        <Text>
        ...
        <Text>
          ...
          selling a total of Five Thousand (5000) copies of such Recordings or
          any combination of such Recordings, condition upon the payment to the
          Licensor a sum of Forty-nine dollars ($49.00), receipt of which is
          ...
          non-commercial use. This license does not allow monetized audio
        ...
        <Text>
          ...
          shall pay to licensor the sum of $99.00 US dollars and other good and
