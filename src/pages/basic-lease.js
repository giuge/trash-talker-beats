...
const BasicLease = () => (
  <Layout>
    <SEO title="Basic Lease" />
    <Container>
      <Title>Basic Lease</Title>
      <Content>
        <Text>
        ...
        <Text>
          ...
          selling a total of Three Thousand (3000) copies of such Recordings or
          any combination of such Recordings, condition upon the payment to the
          Licensor a sum of Twenty-nine dollars ($29.00), receipt of which is
          confirmed. Additionally licensor shall be permitted to distribute{' '}
          10,000 free internet downloads or streams for non-profit and
          non-commercial use. This license does not allow for monetized audio
          streams to sites (like Spotify, RDIO, Rhapsody) and is not eligible
          for monetization on YouTube.
        </Text>
        <TextTitle>Performance Rights</TextTitle>
        <Text>
          The Licensee cannot use the Master Recording for performances, shows,
          or concerts even if for non commercial purposes.
        </Text>
        ...
        <Text>
          ...
          shall pay to licensor the sum of $29.00 US dollars and other good and
          valuable consideration, payable to "Trash Talker", receipt of which is
          hereby acknowledged. If the Licensee fails to account to the Licensor,
          timely complete the payments provided for hereunder, or perform its
          other obligations hereunder, including having insufficient bank
          balance, the licensor shall have the right to terminate License upon
          written notice to the Licensee. Such termination shall render the
        ...
        <Text>
          ...
          <ul>
            <li>Licensee, owns 50% of the writers share.</li>
            <li>
              Davide Morleo (Trash Talker), owns 50% of the writers share.
            </li>
          </ul>
        </Text>
      </Content>
